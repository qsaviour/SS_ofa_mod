...
import unreal
                                                    ...
                                                    ################################## name!!
json_file = open(r'F:\IMModels\ModProject\Dance\Scripts\src\4_song_control\unreal\json_file.txt').read()
print("-------",json_file)

bpm,control_datas = json.load(open(json_file))
# bpm,control_datas = json.load(open(r'F:\IMModels\ModProject\Dance\Song_ful\cache\song_control\control_data.json'))
            ...
            for section in track.get_sections():
                for channel in section.get_channels():
                    ...
                    for value,beat in control_data:
                        frame = int(beat*1.0/bpm*60*60)+OFFSET
                        mark = bool(value)
